const Projects = () => {
    const projectList = [
      ...
      {
        title: "Predictive Modelling of SOC Using Spectroscopy Data",
        desc: "Built models using Elastic Net, SVR, and Polynomial Regression to predict Soil Organic Carbon content, improving model performance by 15% (R2) through feature scaling.",
